...
public class Problem_D4_14695_Sol1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        loop : for (int tc = 1; tc <= T; tc++) {
            ...
            deleteParallelVector(vectors, v1);
    ...
    private static void deleteParallelVector(List<Vector> vectors, Vector v) {
        for (int i = vectors.size() - 1; i >= 0; i--) {
            if (Vector.isParallel(v, vectors.get(i))) {
                vectors.remove(i);
            }
        }
    }
